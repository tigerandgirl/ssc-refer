...
export default function ReferTreeTableSection() {
  return (
    <div className="bs-docs-section">
      <h2 className="page-header">
        <Anchor id="refertreetable">参照组件（树表形参照组件）</Anchor> <small><code>&lt;ReferTreeTable&gt;</code></small>
      </h2>

      <h3><Anchor id="refer-treetable">树表形参照组件</Anchor></h3>
      ...
      <ReactPlayground codeText={Samples.ReferTreeTable} />
